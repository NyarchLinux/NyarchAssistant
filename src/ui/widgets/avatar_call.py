...
class AvatarCallWidget(Gtk.Box):
        ...
        try:
            ...
            if response and self._is_current_call(call_generation):
                ...
                if self._is_current_call(call_generation):
                    ...
                    self._play_tts_with_avatar(response, call_generation)
    ...
    def _play_tts_with_avatar(self, text, call_generation):
        ...
        def on_tts_start():
            GLib.idle_add(self._set_assistant_speaking, call_generation, True)

        def on_tts_stop():
            GLib.idle_add(self._set_assistant_speaking, call_generation, False)
